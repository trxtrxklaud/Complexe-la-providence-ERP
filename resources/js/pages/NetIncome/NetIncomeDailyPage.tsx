...
/**
 * الدخل الصافي اليومي — بأسلوب صفحة المنصّة القديمة
 * (تاريخ + خانة «عرض التفاصيل» + طباعة، ثم جدول بعمودين).
 *
 * أُبقي الكشف التراكمي أسفل كشف اليوم لأنّه كان موجوداً في التقرير القديم
 * ضمن خيار «التراكمي»، وحذفه كان سيُنقِص الإدارة معلومة تستعملها.
 *
