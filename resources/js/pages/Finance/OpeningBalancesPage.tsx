                          ...
                          {bulkEmployees.map((emp) => {
                            ...
                            return (
                              <tr key={emp.id} style={{ borderTop: '1px solid ' + C.line, opacity: hasPayments ? 0.75 : 1 }}>
                                ...
                                <td className="px-3 py-2.5"><input value={row.notes} onChange={(e) => setBulkEmployeeRows((prev) => ({ ...prev, [emp.id]: { ...row, notes: e.target.value } }))} className="w-28 px-2 py-1.5 rounded-lg text-xs" style={fieldStyle} /></td>
