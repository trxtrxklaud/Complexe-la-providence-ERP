    ...
    <div className="px-6 pb-10 max-w-6xl mx-auto" dir="rtl">
      ...
      <div className="print-only mb-4 p-4 border border-slate-900 rounded-xl bg-white text-slate-900">
        <div className="flex items-center justify-between border-b border-slate-300 pb-3">
          <div>
            <h1 className="text-xl font-bold">مدرسة العناية — كشف سحوبات الخزينة الرسمية</h1>
        ...
        <div className="mt-3 grid grid-cols-2 gap-4 text-xs font-semibold bg-slate-50 p-2.5 rounded-lg border border-slate-200 text-center">
          <div>مجموع السحوبات: <span dir="ltr">{money(summary?.withdrawals ?? 0)}</span> د.ت</div>
          <div className="font-bold text-slate-900">الرصيد التراكمي النهائي للخزينة: <span dir="ltr">{money(summary?.balance ?? 0)}</span> د.ت</div>
        </div>
      </div>
      ...
      >
        <div>
          ...
          <div className="bg-white rounded-2xl overflow-hidden" style={{ border: '1px solid ' + C.line }}>
            ...
            <div className="print-only treasury-print-summary rounded-xl p-4 border border-slate-900 bg-white">
              <div className="flex items-center justify-between text-sm font-bold text-slate-900">
                <span>الرصيد التراكمي النهائي للخزينة بعد السحوبات:</span>
